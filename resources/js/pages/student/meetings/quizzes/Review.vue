...
<template>
  <div class="space-y-4">
    ...
    <!-- HEADER -->
    <section
      class="relative overflow-hidden rounded-xl bg-[#173B74] px-5 py-4 text-white shadow-sm">

      <div
        class="absolute right-0 top-0 h-32 w-32 rounded-full bg-cyan-400/10" />
      ...
      <div
        ...
        <!-- SCORE -->
        <div
          class="rounded-xl bg-white/10 px-5 py-4 text-center backdrop-blur-sm">
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <p
              class="text-[10px] font-semibold uppercase text-blue-700">
    ...
    <section
      ...
      <Link
        v-if="canRetry"
        :href="`/student/meetings/${props.meetingId}/quiz`"
      ...
      <Link
        v-if="canContinue"
        :href="`/student/meetings/${props.meetingId}/practice`"
