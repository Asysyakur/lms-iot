...
const instructions = [
  'Buat program Microbit untuk mendeteksi intensitas cahaya.',
  'Gunakan minimal 1 sensor dan 1 LED Matrix.',
  'Tambahkan komentar pada setiap bagian kode.',
  'Upload hasil proyek ke MakeCode lalu salin link proyek.',
];
...
<template>
  <div class="space-y-6">
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            class="mx-2 h-1 flex-1 rounded-full bg-emerald-500"
          />
          ...
          <div
            class="mx-2 h-1 flex-1 rounded-full bg-blue-500"
          />
    ...
    >
      ...
      <button
        class="rounded-2xl bg-slate-300 px-6 py-3 font-semibold text-slate-500"
      >
