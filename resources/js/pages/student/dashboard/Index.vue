...
<template>
        ...
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <!-- TITLE -->
                    <h1 class="text-lg font-bold leading-tight md:text-[32px]">
                        {{ props.student.name }}
                    </h1>

                    <!-- DETAIL -->
                    <p class="mt-1 text-xs text-slate-300 md:text-sm">
            ...
            <div class="w-full xl:w-auto xl:text-right">
                ...
                <h2 class="text-2xl font-bold text-emerald-200 md:text-4xl">
                    {{ props.progress }}%
                </h2>

                <p class="mt-1 text-xs font-bold text-slate-100">
                    Progress Pembelajaran
                </p>

                <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-white/20 xl:w-44">

                    <div :style="{
                        width: props.progress + '%',
                    }" class="h-full rounded-full bg-emerald-200" />
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        <div class="rounded-xl bg-white p-4 shadow-sm xl:col-span-4">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <span class="max-w-[180px] text-right font-semibold text-slate-800">
        ...
        <div class="rounded-xl bg-white p-4 shadow-sm xl:col-span-8">
            ...
            <div class="grid grid-cols-2 gap-3 xl:grid-cols-4">
                ...
                <div v-for="(item, index) in props.stats" :key="index" :class="item.color" class="rounded-xl p-3">
        ...
        <!-- STATISTIK -->
        <div class="rounded-xl bg-white p-4 shadow-sm xl:col-span-6">
        ...
        <div class="rounded-xl bg-white p-4 shadow-sm xl:col-span-6">
            ...
            <button v-if="props.activities.length > 5" @click="showAllActivities = true"
    ...
    <div v-if="showAllActivities" @click="showAllActivities = false"
        ...
        <div @click.stop class="max-h-[85vh] w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl">
