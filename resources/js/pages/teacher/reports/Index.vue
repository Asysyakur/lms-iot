    ...
    <section
      ...
      <div
        ...
        <Link
          ...
          :key="menu.id"
          :href="menu.href"
          class="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-1 hover:border-emerald-300 hover:shadow-md">

          <!-- ICON -->
          <div
            :class="menu.color"
            class="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br text-sm font-bold text-white">
          ...
          <!-- ACTION -->
          <div
            class="mt-4 text-sm font-semibold text-emerald-600">
    ...
    <section
      ...
      <div
        ...
        <div
          ...
          <div
            v-for="meeting in props.meetingProgress"
            :key="meeting.id">
      ...
      <div
        ...
        <div
          class="mt-5 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm leading-relaxed text-slate-600">
