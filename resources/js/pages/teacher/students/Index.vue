...
<template>
  <div class="space-y-8">
    ...
    >
      <div
        class="absolute right-0 top-0 h-56 w-56 rounded-full bg-white/10"
      />
      ...
      >
        <div>
          <div
            class="mb-4 inline-flex rounded-full bg-white/20 px-4 py-1 text-xs font-bold uppercase tracking-wider"
          >
            Manajemen Siswa
          </div>
          ...
          <p
            class="mt-3 max-w-3xl text-lg text-slate-200"
          >
    ...
    >
      <!-- FORM -->
      <div
        class="rounded-3xl bg-white p-6 shadow-sm xl:col-span-7"
      >
        <div
      ...
      >
        ...
        >
          <h2
            class="mb-6 text-lg font-bold text-slate-800"
          >
            Ringkasan Akun
          </h2>
          ...
          >
            ...
            >
              ...
              <h2
                class="mt-2 text-4xl font-black text-blue-700"
              >
                {{ totalStudents }}
              </h2>
            </div>
            ...
            >
              ...
              <h2
                class="mt-2 text-4xl font-black text-emerald-700"
              >
                {{ activeStudents }}
              </h2>
            </div>
            ...
            >
              ...
              <h2
                class="mt-2 text-4xl font-black text-amber-700"
              >
                {{ inactiveStudents }}
              </h2>
            </div>
            ...
            >
              ...
              <h2
                class="mt-2 text-4xl font-black text-red-700"
              >
                {{ deletedStudents }}
              </h2>
            </div>
    ...
    >
      ...
      >
        ...
        <div
          class="rounded-2xl bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-600"
        >
          {{ students.length }}
          Siswa
        </div>
      ...
      >
        ...
        >
          ...
          >
            <tr>
              <th
                class="px-5 py-4 text-left text-sm font-semibold"
              >
                No
              </th>
              ...
              <th
                class="px-5 py-4 text-center text-sm font-semibold"
              >
                Aksi
              </th>
            </tr>
          ...
          <tbody>
            ...
            >
              ...
              <!-- NAME -->
              <td
                class="px-5 py-4 font-semibold text-slate-800"
              >
                {{ student.name }}
              </td>
